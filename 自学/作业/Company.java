...
public class Company  {
	...
	Map<Integer,Employee> 员工 = new HashMap<Integer,Employee>();
	Map<String,List<DakaInfo>> 打卡信息 = new HashMap<String,List<DakaInfo>>();
	//key为签到日期
	
	public Map<Integer, Employee> 新增人员(String name,int ID){
		员工.put(ID, new Employee(ID, name));
		return 员工;
	}
	
	public void 删除人员(int ID){
		员工.remove(ID);
	}
	
	public void 查找人员(int ID) {
		System.out.println("ID："+ID+"\t"+"姓名\t"+员工.get(ID).getName());
	}
	
	public void 显示员工信息(int ID) {
